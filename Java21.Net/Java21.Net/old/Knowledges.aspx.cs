...
namespace Java21.Net
{
    public partial class Knowledges : System.Web.UI.Page
    {
        ...
        {
            JavaDLL bll = new JavaDLL();
            if (bll.addArticle(txtTitle.Text.Trim(), 1, content, ((UserInfo)Session["LoginUser"]).UserName))
        ...
        {
            JavaDLL bll = new JavaDLL();
            if (bll.updateArticle(Convert.ToInt32(Request.QueryString["id"]),1, txtTitle.Text.Trim(), content, ((UserInfo)Session["LoginUser"]).UserName))
