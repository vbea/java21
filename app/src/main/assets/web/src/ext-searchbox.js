...
var html = '<div class="ace_search right">\
    ...
    <div class="ace_search_form">\
        ...
        <span action="findAll" class="ace_searchbtn" title="Alt-Enter">查找所有</span>\
    </div>\
    <div class="ace_replace_form">\
        ...
        <span action="replaceAll" class="ace_searchbtn">替换全部</span>\
    </div>\
    <div class="ace_search_options">\
        <span action="toggleReplace" class="ace_button" title="在查找和替换模式之间切换"\
            style="float:left;margin-top:-2px;padding:0 5px;">+</span>\
        <span class="ace_search_counter"></span>\
        <span action="toggleRegexpMode" class="ace_button" title="正则搜索">.*</span>\
        <span action="toggleCaseSensitive" class="ace_button" title="大小写搜索">Aa</span>\
        <span action="toggleWholeWords" class="ace_button" title="完整搜索">\\b</span>\
        <span action="searchInSelection" class="ace_button" title="搜索选中的文本">_S</span>\
    </div>\
</div>'.replace(/> +/g, ">");
