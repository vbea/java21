...
public class BrowserSet extends BaseActivity
{
	...
	public void onSettings() {
		SH_home = EasyPreferences.getString("web_home", "http://");
		...
		SH_UA = EasyPreferences.getInt("web_ua", 0);
	...
	public void setSetting() {
		if (SH_home.equalsIgnoreCase("http://") || SH_home.equalsIgnoreCase("https://") || SH_home.equalsIgnoreCase("ftp://"))
			SH_home = "";
		EasyPreferences.putString("web_home", SH_home);
		EasyPreferences.putInt("web_search", SH_search);
		EasyPreferences.putInt("web_ua", SH_UA);
		EasyPreferences.putString("web_savepath", SH_savePath);
