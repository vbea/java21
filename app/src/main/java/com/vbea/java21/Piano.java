...
public class Piano extends AppCompatActivity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		pianoLayout = (LinearLayout) findViewById(R.id.pianoLayout);
	...
	{
		 View view = mLayoutInflate.inflate(R.layout.piano_normal1, pianoLayout, false);
		 TextView btn1 = (TextView) view.findViewById(R.id.pianoX1);
		 btn1.setText(key);
	...
	private void addViewBy3(String[] key, String tone)
	{
		...
		if (key.length == 2)
		{
			View view = mLayoutInflate.inflate(R.layout.piano_normal3, pianoLayout, false);
			TextView btn1 = (TextView) view.findViewById(R.id.piano3_1);
			TextView btn2 = (TextView) view.findViewById(R.id.piano3_2);
			TextView btn3 = (TextView) view.findViewById(R.id.piano3_c);
			btn1.setText(key[0]);
	...
	private void addViewBy5(String[] key, String[] tone)
	{
		...
		{
			View view = mLayoutInflate.inflate(R.layout.piano_normal5, pianoLayout, false);
			TextView btn1 = (TextView) view.findViewById(R.id.piano5_1);
			TextView btn2 = (TextView) view.findViewById(R.id.piano5_2);
			TextView btn3 = (TextView) view.findViewById(R.id.piano5_3);
			TextView btn4 = (TextView) view.findViewById(R.id.piano5_c1);
			TextView btn5 = (TextView) view.findViewById(R.id.piano5_c2);
			btn1.setText(key[0]);
			btn1.setOnTouchListener(new MyPlay(key[0]));
			btn2.setText(key[1]);
			btn2.setOnTouchListener(new MyPlay(key[1]));
	...
	private void addViewBy7(String[] key, String[] tone)
	{
		...
		{
			View view = mLayoutInflate.inflate(R.layout.piano_normal7, pianoLayout, false);
			TextView btn1 = (TextView) view.findViewById(R.id.piano7_1);
			TextView btn2 = (TextView) view.findViewById(R.id.piano7_2);
			TextView btn3 = (TextView) view.findViewById(R.id.piano7_3);
			TextView btn4 = (TextView) view.findViewById(R.id.piano7_4);
			TextView btn5 = (TextView) view.findViewById(R.id.piano7_c1);
			TextView btn6 = (TextView) view.findViewById(R.id.piano7_c2);
			TextView btn7 = (TextView) view.findViewById(R.id.piano7_c3);
			btn1.setText(key[0]);
			btn1.setOnTouchListener(new MyPlay(key[0]));
			btn2.setText(key[1]);
			btn2.setOnTouchListener(new MyPlay(key[1]));
