...
public class BezierInterpolator implements Interpolator {
    ...
    private static BezierInterpolator interpolator;
    ...
    public static BezierInterpolator getInstance() {
    ...
    public float getInterpolation(float v) {
        ...
        int position = Math.min((int)(v * (VALUES.length - 1)),
                VALUES.length - 2);

        float quantized = position * STEP_SIZE;
        float difference = v - quantized;
