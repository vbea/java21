...
public class ReadUtil {
    ...
    private static final String READ_Java = "read_java";
    private static final String READ_JavaAdvance = "read_java2";
    private static final String READ_J2EE = "read_javaee";
    private static final String READ_Android = "read_android";
    private static final String READ_AndroidAdvance = "read_android2";
    private static final String READ_AIDE = "read_aide";
    private static final String READ_Database = "read_database";
