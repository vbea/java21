...
/**
 * Created by Vbe on 2018/10/29.
 */

public class RippleColorView extends ViewGroup {
    ...
    public RippleColorView(Context context) {
        this(context, null);
    }

    public RippleColorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RippleColorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void reveal(final int x, final int y, final int color, Animator.AnimatorListener listener) {
        final int duration = getResources().getInteger(R.integer.animationDurationReveal);
    ...
    public void hide(final int x, final int y, final int color, final Animator.AnimatorListener listener) {
        final int duration = getResources().getInteger(R.integer.animationDurationHide);
    ...
    public void hide() {
        hide(0,0,Color.TRANSPARENT,0,0,null);
    }

    public ViewPropertyAnimator prepareAnimator(ViewPropertyAnimator animator, int type) {
        animator.withLayer();
        animator.setInterpolator(BezierInterpolator.getInstance());
        return animator;
    }
